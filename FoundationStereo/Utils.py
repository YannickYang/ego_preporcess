...
try:
  ...
  # Dense disparity inference does not need Open3D. Keep it optional so the
  # model can be embedded in pipelines that do not export point clouds.
  o3d = None
import cv2
import numpy as np
...
def toOpen3dCloud(points,colors=None,normals=None):
  if o3d is None:
    raise ImportError("Open3D is required only for point-cloud export")
